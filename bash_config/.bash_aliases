...
alias ls="eza -Alh --group-directories-first" # preferred listing
alias la="eza -Ah --group-directories-first" # all files and directories
alias ll="eza -lh --group-directories-first" # long format
alias lt="eza -ATh --group-directories-first" # tree format
